...
```
30대 남성. 짧은 짙은 갈색 머리.
검은 크루넥 스웨터. 얇은 체인 목걸이.
카페에서 커피잔과 책을 앞에 두고 앉은 장면.
실사 사진 스타일.
...
[첨부 ①: 라즈베리·블루베리·타월이 있는
         욕실 소품 배경 사진]
[첨부 ②: Pink Rabbit Body Lotion 제품 단독 컷]
...
**팁**: **배경씬 + 제품** 두 장을 따로 첨부해 합성 요청.
그림자·반사 방향을 지정하면 합성 티가 덜 난다.
...
---
layout: image-right
image: /images/6.3-food-after.png
---

# 6.3 음식에 소품 추가

평범한 식당 사진 → 다이나믹 푸드 포토
...
찍기 어려운 연출을 AI로 대체. 식당·배달앱·푸드 블로거에게 유용.

<!--
실제 촬영이면 전문 스튜디오가 필요한 연출. 프롬프트 한 줄로 해결.
-->
...
---
layout: image-right
image: /images/tshirt-model.jpeg
---

# 6.5 굿즈 목업 · 모델 컷

로고 → 티셔츠 목업 → 모델 착용 컷, 3단계

**1단계** — 티셔츠 목업
```
"Caffee Handee" 로고가 프린트된
베이지 크루넥 티셔츠.
나무 테이블 위에 펼쳐진 제품 컷.
```
...
<!--
로고 제작 → 굿즈 → 모델 컷까지 모두 AI로. 실제 촬영비 대비 효과 압도적.
-->

---
layout: image-right
image: /images/6-6-after.jpeg
---
...
**예시**: Caffee Handee 카페 청사진 → 3D 시뮬레이션
...
**팁**: 로고 → 간판 → 평면도 → 3D 시뮬레이션. **브랜드 하나로 끝까지**.
...
---
layout: image-right
image: /images/monarisa-after.jpeg
---
...
**팁**: "민화", "수묵화", "한지 질감", "낙관" — 한국 미술 용어 그대로 사용.

<!--
모나리자처럼 저작권 없는 명화로 시연하면 재미와 설득력이 동시에. 수묵화는 hanbok 소녀 예시로.
-->

---
layout: image-right
image: /images/6-13-after.jpeg
---
...
⚠️ 공인·역사 인물은 가능. 생존 개인 얼굴 업로드 전 **3.1** 원칙 재확인

**팁**: "과하게 선명하지 않게". 너무 또렷해지면 **다른 얼굴**이 된다.

<!--
감정적·역사적 가치가 큰 작업. 보수적으로 복원하는 것이 원칙.
-->
